...
static const _Gimbal_type_support_symbol_names_t _Gimbal_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, gimbal_interface, msg, Gimbal)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, gimbal_interface, msg, Gimbal)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, gimbal_interface, msg, Gimbal)() {
  return &::gimbal_interface::msg::rosidl_typesupport_c::Gimbal_message_type_support_handle;
}
