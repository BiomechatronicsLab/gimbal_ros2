...
#include "gimbal_interface/msg/detail/gimbal__rosidl_typesupport_fastrtps_c.h"
...
#include "gimbal_interface/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
using _Gimbal__ros_msg_type = gimbal_interface__msg__Gimbal;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_gimbal_interface
size_t get_serialized_size_gimbal_interface__msg__Gimbal(
  const void * untyped_ros_message,
...
static uint32_t _Gimbal__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_gimbal_interface__msg__Gimbal(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_gimbal_interface
size_t max_serialized_size_gimbal_interface__msg__Gimbal(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = gimbal_interface__msg__Gimbal;
    is_plain =
      (
...
static size_t _Gimbal__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_gimbal_interface__msg__Gimbal(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, gimbal_interface, msg, Gimbal)() {
