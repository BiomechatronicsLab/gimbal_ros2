...
#include "gimbal_interface/msg/detail/gimbal__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = gimbal_interface::msg::Gimbal;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const gimbal_interface::msg::Gimbal *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<gimbal_interface::msg::Gimbal *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_gimbal_interface
const rosidl_message_type_support_t *
get_message_type_support_handle<gimbal_interface::msg::Gimbal>()
{
  return &gimbal_interface::msg::typesupport_fastrtps_cpp::_Gimbal__handle;
}
