...
bool gimbal_interfaces__msg__gimbal__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("gimbal_interfaces.msg._gimbal.Gimbal", full_classname_dest, 36) == 0);
  }
  gimbal_interfaces__msg__Gimbal * ros_message = _ros_message;
  {  // pan
...
PyObject * gimbal_interfaces__msg__gimbal__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("gimbal_interfaces.msg._gimbal");
