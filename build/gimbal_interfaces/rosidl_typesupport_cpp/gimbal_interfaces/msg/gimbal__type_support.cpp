...
static const _Gimbal_type_support_symbol_names_t _Gimbal_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, gimbal_interfaces, msg, Gimbal)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, gimbal_interfaces, msg, Gimbal)),
  }
};
...
{
  return &::gimbal_interfaces::msg::rosidl_typesupport_cpp::Gimbal_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, gimbal_interfaces, msg, Gimbal)() {
  return get_message_type_support_handle<gimbal_interfaces::msg::Gimbal>();
}
