...
{
  new (message_memory) gimbal_interfaces::msg::Gimbal(_init);
}

void Gimbal_fini_function(void * message_memory)
{
  auto typed_message = static_cast<gimbal_interfaces::msg::Gimbal *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Gimbal_message_member_array[2] = {
  {
    ...
    offsetof(gimbal_interfaces::msg::Gimbal, pan),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(gimbal_interfaces::msg::Gimbal, tilt),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Gimbal_message_members = {
  "gimbal_interfaces::msg",  // message namespace
  "Gimbal",  // message name
  2,  // number of fields
  sizeof(gimbal_interfaces::msg::Gimbal),
...
{
  return &::gimbal_interfaces::msg::rosidl_typesupport_introspection_cpp::Gimbal_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, gimbal_interfaces, msg, Gimbal)() {
  return &::gimbal_interfaces::msg::rosidl_typesupport_introspection_cpp::Gimbal_message_type_support_handle;
}
